#!/usr/bin/env python3
"""Item sprites and the GUI panel layouts.  Nothing in textures/block/ - see below.
...
Every block texture belongs to gen_block_textures.py.  This file once wrote twenty of them too, at the
old low resolution, and ran second - so it silently overwrote the good ones on every regeneration.
check_generated_assets.py fails the build if two generators claim one path.
"""
...
# The reel sprites' palettes, which lived beside the block textures this file used to write.
